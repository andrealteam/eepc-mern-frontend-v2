...
const FavouriteExporterProfile = () => {
  ...
  const filteredData = useMemo(() => {
    ...
    return exporterProfile
      ?.map((item) => {
        ...
        // ✅ 4️⃣ Return data only if all filters match
  ...
  return (
    <div>
      ...
      <div class="row mt-5 align-items-center">
        <div class="col-lg-8">
          <h3 class="mb-0">Favourite Exporter Panel</h3>
        </div>
        <div class="col-lg-4">
...
export default FavouriteExporterProfile;
